...
const TARGET_PATH = '/journal/ai-collaboration-checklist/index.html'
...
export const Route = createFileRoute('/insights/ai-collaboration-checklist.html')({
  ...
  component: InsightAiCollaborationChecklistRedirectPage,
})

function InsightAiCollaborationChecklistRedirectPage() {
  React.useEffect(() => {
